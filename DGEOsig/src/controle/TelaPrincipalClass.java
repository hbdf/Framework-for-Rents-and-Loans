...
public class TelaPrincipalClass implements Initializable {
    ...
    void loadRegistrarEmprestimo(ActionEvent event) {
		loadWindow("Realizar Empr�stimo", "src/view/TelaRealizarEmprestimo.fxml"); 
    }
	
	@FXML
    void loadEncerrarEmprestimo(ActionEvent event) {
		
		loadWindow("Encerrar Empr�stimo", "src/view/TelaEncerrarEmprestimo.fxml"); 
    }    
	
	@FXML
    void loadBuscarUsuario(ActionEvent event) {
		
		loadWindow("Buscar Usu�rio", "src/view/TelaBuscarUsuario.fxml");
    }
    ...
    void loadCadastrarUsuario(ActionEvent event) {
		...
		loadWindow("Cadastrar Novo Usu�rio", "src/view/TelaCadastrarUsuario.fxml");
    }
